  ...
  (c.prototype.render = function () {
    ...
    var b =
      ...
      c = a("<label class=\"btn\">")
        ...
        .addClass(this._onstyle + " " + b),
      d = a("<label class=\"btn\">")
        .html(this.options.off)
        .addClass(this._offstyle + " " + b + " active"),
      e = a("<span class=\"toggle-handle btn btn-black\">").addClass(b),
      f = a("<div class=\"toggle-group\">").append(c, d, e),
      g = a("<div class=\"toggle btn\" data-toggle=\"toggle\">")
        .addClass(
    ...
    var h =
          this.options.width ||
          Math.max(c.outerWidth(), d.outerWidth()) + e.outerWidth() / 2,
      i = this.options.height || Math.max(c.outerHeight(), d.outerHeight());
    c.addClass("toggle-on"),
